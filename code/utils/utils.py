...
class Logger():
    def __init__(self, env_name ,ports, n_epochs, batches_epoch, image_update_freq=10):
        ...
        self.loss_windows = {}
        self.image_windows = {}
        self.image_update_freq=image_update_freq
        self.count = 0
    ...
    def log(self, losses=None, images=None):
        ...
        # Draw images
        if self.count % self.image_update_freq == 0:
